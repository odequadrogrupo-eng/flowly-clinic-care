...
import { listActiveQueueItems, reorderQueueItems } from "@/services/queue";
...
export function useActiveQueue(clinicId: string, professionalId?: string) {
  ...
  return useQuery({
    ...
    queryFn: () => listActiveQueueItems(clinicId, professionalId),
  });
}
          ...
          return (
            ...
            >
              ...
              <div className="flex flex-wrap items-center gap-2">
                ...
                {item.status === "called" || item.status === "called_service" ? (
                  <Button
                    size="sm"
                    variant="secondary"
